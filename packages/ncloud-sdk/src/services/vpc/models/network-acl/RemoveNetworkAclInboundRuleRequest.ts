/**
 * Network ACL Inbound Rule 제거 요청 타입
 * @see {@link https://api.ncloud-docs.com/docs/networking-vpc-networkacl-removenetworkaclinboundrule}
 */
export interface RemoveNetworkAclInboundRuleRequest {
    /**
     * 리전 코드
     * Inbound 규칙을 제거할 Network ACL의 리전(Region) 결정
    ...
    networkAclRuleList: Array<{
         ...
         * Min : 0, Max : 199
         * @description 다른 Inbound 규칙의 우선순위와 중복될 수 없음
         */
        priority: number;

/**
 * Network ACL Inbound Rule 추가 요청 타입
 * @see {@link https://api.ncloud-docs.com/docs/networking-vpc-networkacl-addnetworkaclinboundrule}
 */
export interface AddNetworkAclInboundRuleRequest {
    /**
     * 리전 코드
     * Inbound 규칙을 추가할 Network ACL의 리전(Region) 결정
